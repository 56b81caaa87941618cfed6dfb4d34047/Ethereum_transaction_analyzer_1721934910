...
Vue.component("purple_feature_grid_component_1721934912", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the game with our cutting-edge transaction monitoring system. Get instant updates on new Ethereum transactions as they occur, giving you a competitive edge in the ever-evolving blockchain landscape.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform provides comprehensive analysis of Ethereum transactions, dissecting each component to uncover valuable insights. Gain a deeper understanding of transaction patterns, behaviors, and anomalies.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            ...
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Tailor the app to your specific needs by setting up personalized alerts and notifications. Stay informed about transactions that meet your predefined criteria, ensuring you never miss a beat.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">User-Friendly Interface</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Navigate through our intuitive and sleek interface, designed to provide a seamless experience. Easily access and interpret transaction data, empowering you to make informed decisions efficiently.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Built with robust security measures, our app ensures the utmost protection of your data and transactions. Trust our reliable platform to handle your Ethereum analysis needs with confidence.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 font-medium" :class="textSecondaryStyle">Scalable and Future-Proof</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">As the Ethereum network continues to evolve, our app is designed to adapt and scale seamlessly. Stay ahead of the curve with a future-proof solution that grows alongside the ever-changing blockchain landscape.</p></div>
        </div>
    </div>`,
        data() {
            return {
